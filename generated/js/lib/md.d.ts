export declare const protobufPackage = "md";
/**
 ...
 * `1 / r`, and vice versa.
 */
export declare enum RateUpdateSide {
...
export interface MdMessage {
    ...
    mboSnapshot?: MarketByOrder | undefined;
    /** Market by order diff */
    mboDiff?: MarketByOrderDiff | undefined;
    /** Market by price snapshot */
    mbpSnapshot?: MarketByPrice | undefined;
 ...
 */
export declare enum MarketByOrderDiff_DiffOp {
    ADD = 0,
    REMOVE = 1,
    REPLACE = 2
}
...
export interface AggMessage {
    ...
    heartbeat?: Heartbeat | undefined;
    /** Top of books */
    topOfBooks?: TopOfBooks | undefined;
