...
export declare enum CancelOrderAck_Reason {
    UNCLASSIFIED = 0,
    DISCONNECT = 1,
...
export interface MassCancelAck {
    ...
    /** [Transact time](#transact-time) */
    transactTime: bigint;
    reason?: MassCancelAck_Reason | undefined;
    /** The total number of orders that were canceled. */
    totalAffectedOrders: number;
}
export declare enum MassCancelAck_Reason {
    UNCLASSIFIED = 0,
    INVALID_MARKET_ID = 1,
    INVALID_SIDE = 2
}
 ...
 */
export declare enum NewOrderReject_Reason {
    UNCLASSIFIED = 0,
...
export declare enum CancelOrderReject_Reason {
    UNCLASSIFIED = 0,
    /** INVALID_MARKET_ID - The specified market ID does not exist. */
    INVALID_MARKET_ID = 1,
    /**
 ...
 * corresponding field did not take a valid value.
 */
export declare enum ModifyOrderReject_Reason {
    UNCLASSIFIED = 0,
    /** INVALID_QUANTITY - Quantity was zero. */
    INVALID_QUANTITY = 1,
    /** INVALID_MARKET_ID - The specified market ID does not exist. */
